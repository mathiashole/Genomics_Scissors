...
# # Original Author: Miguel Ponce de Leon
# # Modified by: Mathias Mangino
# # Additional modifications for format support
# # -----------------------------------------------------------------------------

# # Main program
# my ($fasta_file, $coord_file, $coord_format, $output_file, $flag_not_to_upper) = @ARGV;
# die "\nError: Missing multifasta file\n" unless $fasta_file;
# die "\nError: Missing coordinate file\n" unless $coord_file;
# die "\nError: Missing coordinate format\n" unless $coord_format;
